...
using mongotest.Api.Filters;
using mongotest.BusinessServices.Installer;

namespace mongotest.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "mongotest API", Version = version + "-" + branch});
            });
