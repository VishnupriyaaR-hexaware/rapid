using mongotest.Api.Installer;
using mongotest.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using mongotest.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace mongotest.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "mongotest V1");
        });
