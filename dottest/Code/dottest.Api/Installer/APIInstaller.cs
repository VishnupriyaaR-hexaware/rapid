...
using dottest.Api.Filters;
using dottest.BusinessServices.Installer;

namespace dottest.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dottest API", Version = version + "-" + branch});
            });
